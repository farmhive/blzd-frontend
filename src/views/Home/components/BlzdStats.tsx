...
import { Card, CardBody, Heading, Text } from '@farmhive/uikit'
    ...
    <StyledBlzdStats>
      <CardBody>
        <Heading size="xl" mb="24px">
          {TranslateString(534, 'FARMHIVE Stats')}
        </Heading>
        <Row>
          <Text fontSize="14px">{TranslateString(536, 'Total FARMHIVE Supply')}</Text>
        ...
        <Row>
          <Text fontSize="14px">{TranslateString(538, 'Total FARMHIVE Burned')}</Text>
          <CardValue fontSize="14px" value={getBalanceNumber(burnedBalance)} decimals={0} />
        </Row>
        <Row>
          <Text fontSize="14px">{TranslateString(540, 'New FARMHIVE/block')}</Text>
